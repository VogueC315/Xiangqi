...
LARGEUR_BANDE = 200     
TAILLE_FENETRE_LARGEUR = NOMBRE_COLONNES * TAILLE_CASE + LARGEUR_BANDE
...
class Board:
    ...
    def dessiner_boutons(self, ecran):
        """Dessine les boutons dans la bande à droite."""
        # Couleurs des boutons et du texte
        COULEUR_BOUTON = (200, 200, 200)
        COULEUR_TEXTE = (0, 0, 0)

        # Dessiner les boutons
        pygame.draw.rect(ecran, COULEUR_BOUTON, (TAILLE_FENETRE_LARGEUR - LARGEUR_BANDE + 20, 20, 160, 50))
        pygame.draw.rect(ecran, COULEUR_BOUTON, (TAILLE_FENETRE_LARGEUR - LARGEUR_BANDE + 20, 100, 160, 50))

        # Dessiner le texte des boutons
        font = pygame.font.Font(None, 36)
        text_bouton1 = font.render("Bouton 1", True, COULEUR_TEXTE)
        text_bouton2 = font.render("Bouton 2", True, COULEUR_TEXTE)
        ecran.blit(text_bouton1, (TAILLE_FENETRE_LARGEUR - LARGEUR_BANDE + 50, 30))
        ecran.blit(text_bouton2, (TAILLE_FENETRE_LARGEUR - LARGEUR_BANDE + 50, 110))
        ...
        if self.piece_selectionnee:
            ...
            for row in self.m:
                for piece in row:
                    if piece:
                        piece.dessiner(self.ecran)
        self.plateau.dessiner_boutons(self.ecran)
        pygame.display.flip()
